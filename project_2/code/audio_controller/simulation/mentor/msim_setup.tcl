...
# ----------------------------------------
# If audio_controller is one of several IP cores in your
...
# ----------------------------------------
# ACDS 22.1 915 win32 2023.04.13.09:33:12
...
if ![info exists TOP_LEVEL_NAME] { 
  set TOP_LEVEL_NAME "audio_controller"
}
...
alias com {
  ...
  eval  vlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/audio_controller_audio_0.v"        -work audio_0
  eval  vlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/audio_controller.v"                                        
}
...
alias elab_debug {
  ...
  eval vsim -voptargs=+acc -t ps $ELAB_OPTIONS $USER_DEFINED_ELAB_OPTIONS -L work -L work_lib -L audio_0 -L altera_ver -L lpm_ver -L sgate_ver -L altera_mf_ver -L altera_lnsim_ver -L cyclonev_ver -L cyclonev_hssi_ver -L cyclonev_pcie_hip_ver $TOP_LEVEL_NAME
}
